...
public class ShopDemoProblemDetailsFactory : ProblemDetailsFactory
{
    ...
    public ShopDemoProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
    {
        ...
        string? instance = null)
    {
        ...
        if (title != null)
        {
            //Para validação dos detalhes do problema, não sobrescrever o titulo padrão com null.
